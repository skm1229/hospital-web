...
import com.atguigu.hospclient.HospitalFeignClient;
import com.atguigu.userclient.PatientFeignClient;
import com.atguigu.yygh.common.rabbitmq.constant.MqConst;
import com.atguigu.yygh.common.rabbitmq.service.RabbitService;
...
public class OrderServiceImpl extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        //请求医院系统接口 返回来数的数据就是可预约数量变少等封装在内的对象，我们取出字段更新到我们数据库的排班表就可以了
        //用老师的这个报错。我们用下面的 JSONObject result = HttpRequestHelper.sendRequest(paramMap, signInfoVo.getApiUrl() + "/order/submitOrder");
